...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- css -->
        <link rel="stylesheet" href="/css/style.css" type="text/css" media="screen and (min-width: 390px)">
        <link rel="stylesheet" href="/css/mstyle.css" type="text/css" media="screen and (max-width: 389px)">
