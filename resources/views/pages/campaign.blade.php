...
<div class="campaign">
	...
	<div style="display: flex; width: 90%">
		<div class="block item resizeimage">
			<img class="campaign_detail" src="/images/furniture.webp">
		</div>
		<div class="item">
			<img class="detail1" style="display: flex;" src="/images/service-kaitori-price.png">
	...
	<div style="display: flex; width: 90%">
		...
		<div class="item">
			<img class="detail1" style="display: flex;" src="/images/service-other-price1.png">
	...
	<div style="display: flex; width: 90%">
		...
		<div class="item">
			<img class="detail1" style="display: flex;" src="/images/service-other-price2.png">
	...
	<div class="display: flex; width: 90%;">
		<div class="block item resizeimage">
